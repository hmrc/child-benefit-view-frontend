...
class VerifyHICBCActionSpec extends BaseAppSpec with MockitoSugar {
  ...
  def generateCobClaimantInfo(adjustmentReasonCode: AdjustmentReasonCode, adjustmentEndDate: LocalDate): ClaimantBankInformation =
  ...
  implicit val request: IdentifierRequest[AnyContentAsEmpty.type] = IdentifierRequest(FakeRequest(GET, ""), NationalInsuranceNumber("123456"), true, "")
