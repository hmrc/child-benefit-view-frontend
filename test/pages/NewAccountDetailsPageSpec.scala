...
class NewAccountDetailsPageSpec extends PageBehaviours {
  ...
  "NewAccountDetailsPage" - {
    ...
    beRetrievable[NewAccountDetails](NewAccountDetailsPage)

    beSettable[NewAccountDetails](NewAccountDetailsPage)

    beRemovable[NewAccountDetails](NewAccountDetailsPage)
  }
}
